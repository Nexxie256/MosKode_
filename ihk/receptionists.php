<?php
	...
	echo("<center>");
	echo("<h1><u>"."Receptionists"."</u></h1>");
	echo("<hr>");
	echo("<form method='POST' action='add_receptionist.php'>
			<br>
	...
	if($result->num_rows>0){
		...
		while($row = $result->fetch_array()){
			...
			echo("<td>$row[1]</td>
				...
				<td>$row[4]</td>
				<td>
					<form method='POST' action='delete_receptionist.php'>
						<input type='hidden' value='$pk' name='primary'>
						<input id='delete' type='submit' value='Delete'>
					</form>
				<td>
				<form method='POST' action='update_receptionist.php'>
					<input type='hidden' value='$pk' name='primary'>
