<?php
	...
	echo("<center>");
	echo("<h1><u>"."Accountants"."</u></h1>");
	echo("<hr>");

	echo("<form method='POST' action='add_accountant.php'>
			<br>
			...
			<br>
			<input type='text' class='in' pattern='[^MF]{1}' placeholder='Gender' name='gender'>
			<br><br>
	...
	if($result->num_rows>0){
		...
		while($row = $result->fetch_array()){
			...
			echo("<td>$row[1]</td>
				...
				<td>$row[4]</td>
				<td>
					<form method='POST' action='delete_accountant.php'>
						<input type='hidden' value='$pk' name='primary'>
						<input id='delete' type='submit' value='Delete'>
					</form>
				<td>
				<form method='POST' action='update_accountant.php'>
					<input type='hidden' value='$pk' name='primary'>
